...
*/
    ...
    choices: [(‘Red’, FF0000, FFFFFF), (‘Yellow’, FFFF00, 000000), (‘Green’, 00FF00, FFFFFF), (‘Cyan’, 00FFFF, 000000), (‘Blue’, 0000FF, FFFFFF), (‘Magenta’, FF00FF, 000000)]
  }
  ...
  function setupWorkView() {
    ...
    for(var i=0; i<prm.choices.length; i++) {
      ...
      $('#choices').append('<button id="choice-'+c+'" STYLE=”background-color:prm.choices[i][1];color:prm.choices[i][2]”>'+prm.choices[i][0]+'</button>');
