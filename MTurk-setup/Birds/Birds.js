$(document).ready(function() {
  ...
  defaultPrm = {
    ...
    sideInstructions: '{{sideInstrictions}}',
    trainingIntructions: '{{trainingIntructions}}',
    ...
    examples: [
      ...
      ['EX-2-003',1],
      ['EX-1-003',0]],
    text1 = [ “Sage Thrasher”,“Cactus Wren”,“Northern Waterthrush”,“Blue Grosbeak”,“Indigo Bunting”,“Lazuli Bunting” ]
    exampleChoices: ['Yes', 'No'],
    showRewardFeedback: 0,
    showBinaryRewardFeedback: 0,
    showScore: 0,
    rewardMatrix: [[5, -5], [-10, 10]],
    choices: ['Sage Thrasher', 'Cactus Wren', 'Northern Waterthrush', 'Blue Grosbeak', 'Indigo Bunting', ‘Lazuli Bunting’]
  }
  ...
  function setupWorkView() {
    ...
    for(var i=0; i<prm.choices.length; i++) {
      ...
      $('#choices').append('<button id="choice-'+c+'">'+prm.choices[i]+'</button>');
