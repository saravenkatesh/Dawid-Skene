...
'''g = open('/Users/saraswathivenkatesh/svenkate-surf-2011-mturk/data/colscale/\
image-ids.yaml', 'r')
names = []
Ids = []
x = g.readline()
...
for i,j in enumerate(times):
    ...
    plt.savefig('Ann'+str(i)+'-times-col.png')
    alltimes.append(mu)
    
f = open('alltimes-col.txt', 'w')
for i in alltimes:
    f.write(str(i)+' ')
f.close()
