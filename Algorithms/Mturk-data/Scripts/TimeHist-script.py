...
'''g = open('/Users/saraswathivenkatesh/svenkate-surf-2011-mturk/data/scriptscale/\
image-ids.yaml', 'r')
names = []
Ids = []
x = g.readline()
...
for i,j in enumerate(times):
    ...
    plt.savefig('Ann'+str(i)+'-times-script.png')
    alltimes.append(mu)

f = open('alltimes-script.txt', 'w')
for i in alltimes:
    f.write(str(i)+' ')
f.close()    
...
ax.text(0.1, 0.95, textstr, transform=ax.transAxes, fontsize=14, \
    verticalalignment='top', bbox=props)
plt.savefig('script-avgtimes.png')